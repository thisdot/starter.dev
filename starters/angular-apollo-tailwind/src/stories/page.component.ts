...
@Component({
    ...
    template: `<article>
        ...
        ></storybook-header>
        <section>         <h2>Pages in Storybook</h2>
              <p>             We recommend building UIs with a            <a
            ...
            <ul>             <li>                Use a higher-level connected component. Storybook helps you
                compose such data from the  "args" of child component stories
                    </li>             <li>                Assemble data in the page component from your services. You can
                mock these services out  using Storybook.                     </li>  
            </ul>
                ...
                >
                    <g fill="none" fillRule="evenodd">
                            ...
                            d="M1.5 5.2h4.8c.3 0 .5.2.5.4v5.1c-.1.2-.3.3-.4.3H1.4a.5.5 0 01-.5-.4V5.7c0-.3.2-.5.5-.5zm0-2.1h6.9c.3 0 .5.2.5.4v7a.5.5 0 01-1 0V4H1.5a.5.5 0 010-1zm0-2.1h9c.3 0 .5.2.5.4v9.1a.5.5 0 01-1 0V2H1.5a.5.5 0 010-1zm4.3 5.2H2V10h3.8V6.2z"
                                      id="a"                         fill="#999"
                        />                 </g>    
                </svg>             Viewports addon in the toolbar               </div>
        </section></article>
>`,
    styleUrls: ['./page.css'],
})
