# nuxt-bridge-pinia-tailwind starter kit

This starter kit features **Nuxt.js Bridge**, **Pinia**, and **Tailwind CSS**.
## Table of Contents
...
- [Nuxt.js Bridge](https://v3.nuxtjs.org/bridge/overview/)
...
In this `starters/nuxt-bridge-pinia-tailwind` directory you will find the `TheCounter` and `TheGreeting` directories. 
...
- Follow the prompts to select the `nuxt-bridge-pinia-tailwind` starter kit and name your new project.
...
This requires a download of the entire starter.dev repository and extraction of the `nuxt-bridge-pinia-tailwind` kit from the starters directory.

```bash
git clone https://github.com/thisdot/starter.dev.git
```

- Copy and rename the `starters/nuxt-bridge-pinia-tailwind` directory to the name of your new project.
- `cd` into your project directory and run `yarn`.
- Run `yarn dev` to start the development server.
- Open your browser to `http://localhost:3000` to see the included example code running.
